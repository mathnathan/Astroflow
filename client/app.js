...
// this is a function generator, probably overly complicated for this purpose
// we probably will just want to write a function for each type of command.
function queryFlask(command, callback) {
